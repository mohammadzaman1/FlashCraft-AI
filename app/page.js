  ...
  return (
    <Box width="100vw" height='auto'> 
      ...
      <AppBar sx={{ position: "sticky", bgcolor: "#0A082Dff"}}>
        <Toolbar color='red'>
          <Typography variant="h6" style={{ flexGrow: 1, color: "gold", fontFamily: 'Jersey 10'}}>
      ...
      >
        ...
        <Button variant="contained" color="primary" sx={{ mt: 2, color:"gold"}} onClick={() => window.location.href = '/generate'}>
          Get Started
        </Button>
      </Box>
      <Box sx={{my: 3, textAlign:{xs: "center", sm:"center"}}}
        p={3}

      >
        <Typography variant="h4" gutterBottom color="gold"> 
          Features
        </Typography>
      ...
      <Box sx={{my: 6, textAlign: 'center', p:'2em'}}>
        <Typography variant="h4" gutterBottom mb={4} color="gold">
          Pricing 
        </Typography>
        <Grid container spacing={4}>
          ...
          >
            ...
            <Typography>
              {' '}
              Access to Unlimited flash card features & limited storage
            </Typography>
              <Button variant="contained" color="primary" sx={{ mt: 2, color: "gold" }} onClick={() => window.location.href = '/generate'}>
              Generate
            </Button>
          ...
          >
            ...
            <Typography>
              {' '}
              Buy us a cup of coffee and get unlimited storage
            </Typography>
              <Button variant="contained" color="primary" sx={{ mt: 2, color: "gold" }} onClick={handleSubmit}>
              Donate
            </Button>
          </Box>
          </Grid>
